...
public class NewDiscoveryWBS {
    ...
    // commenting initialization since states are symbolic anyways.
    /*public NewDiscoveryWBS() {
...
*/
    ...
    public static void launch(int pedal1, boolean auto1, boolean skid1, boolean symVar) {
        NewDiscoveryWBS wbs = new NewDiscoveryWBS();
        if (symVar) wbs.update(pedal1, auto1, skid1);
        //wbs.update(pedal3, auto3, skid3);
    }

    public static void main(String[] args) {
        launch(0, false, false, false);
    }
}
